    ...
    <div class="row mb-2">
      ...
      <div class="col-md-6 col-sm-12" style="font-size: 20px;">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a style="color:#869099;" href="<?php echo base_url();?>index.php/user/create">CREATE</a></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center"><span id="firstname">NAME OF THE USER</span> <span id="middlename"></span> <span id="lastname"></span></p>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link" style="background-color:#6610f2;">CREATE</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  <div>
                    ...
                    <?php echo form_open('user/insert/', $attributes);?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="email" name="email" required="required" placeholder="Enter Your Username">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-sm-2 col-form-label">Enabled:</label>
                        <div class="col-sm-10 pt-2">
